...
#Calling append to the list returns None, so the items must be concatenated differently
...
char_b = Character("Mayu", "Pumiblu", "F", 12, 12, 72, 421, 2500, "Salvajita", 100, 100, 100, pumiblu_parts)
...
equipable_pinchito = Weapon(name="Pinchito", weight=2, strength=2, power=0, range=5, stealth=-10, part=Parts.RIGHT_ARM, description="Autoexplicativo", quality="Common")
equipable_armor = Armor(name="Gambesón", weight=7, defense=5, balance=5, spirit=2, stealth=-2, part=Parts.TORSO, description="Armadura de telas y cueros", quality="Common")
equipable_helmet = Armor(name="Casco Meh", weight=7, defense=5, balance=5, spirit=2, stealth=-2, part=Parts.HEAD, description="Casco Fome", quality="Common")
equipable_tail = Armor(name="Protector de Cola", weight=1, defense=1, balance=5, spirit=2, stealth=-2, part=Parts.TAIL, description="aUTOEXPLICCATIVO", quality="Common")
...
print(char_a.equip_item(equipable_helmet)) #equipping a second helmet to test multiple items on same part
print(char_a.equip_item(equipable_tail)) #The body part exists but the character doesn't have it
...
print(char_b.equip_item(equipable_tail)) #The body part exists and the character has it
